...
class AuthorController extends AbstractController
{
    ...
    public function index(Request $request, AuthorRepository $repository): Response
    {
        ...
        $authors = Pagerfanta::createForCurrentPageWithMaxPerPage(new QueryAdapter($repository->findByDateOfBirth($dates)),
                    $request->query->get(key: 'page', default : 1), maxPerPage: 10);    
